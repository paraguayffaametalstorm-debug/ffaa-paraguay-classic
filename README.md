...
[![Version](https://img.shields.io/badge/version-v4.5.2--hotfix-gold)](https://paraguay-ffaa-metalstorm.fly.dev/)
...
- **Control de Mando RBAC & Cuotas Institucionales:** Restricción jerárquica estricta (1 Comandante en Jefe `OWNER`, máximo 5 Oficiales `ADMIN` y máximo 8 `VETERANO`).
