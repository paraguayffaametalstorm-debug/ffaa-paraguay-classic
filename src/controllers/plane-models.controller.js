...
export const INITIAL_PLANE_MODELS = [
  ...
  },
  {
    id: '24',
    name: 'Su-22 Fitter',
    type: 'Caza de Combate / Ataque Táctico',
    tier: 2,
    special_name: 'Geometría Variable Táctica',
    special_levels: { '1': 'Penetración a baja cota +15%', '2': 'Penetración a baja cota +30%' },
    passive_name: 'Blindaje de Cabina Reforzado',
    passive_levels: { '1': 'Resistencia a fuego antiaéreo +20%' },
    stats_real: { velocidad: 1860, agilidad: 79, blindaje: 1550, potencia_armas: 1390 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['canon_nr30', 'misiles_kh29', 'bombas_ofab'] },
    is_active: true
  },
  {
    id: '25',
    name: 'Su-25 Frogfoot',
    type: 'Avión de Apoyo Aéreo Cercano (CAS)',
    tier: 2,
    special_name: 'Bañera de Titanio Shturmovik',
    special_levels: { '1': 'Absorción de daño +20%', '2': 'Absorción de daño +40%' },
    passive_name: 'Resistencia a Metralla',
    passive_levels: { '1': 'Blindaje estructural +25%' },
    stats_real: { velocidad: 975, agilidad: 74, blindaje: 2100, potencia_armas: 1550 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['canon_gsh30', 'cohetes_s8', 'misiles_vikhr'] },
    is_active: true
  },
  {
    id: '26',
    ...
    type: 'Caza de Superioridad Aérea',
    tier: 3,
    special_name: 'Maniobra Cobra de Pugachev',
    special_levels: { '1': 'Tasa de giro instantáneo +15%', '2': 'Tasa de giro instantáneo +30%' },
    passive_name: 'Fuselaje Integrado Sustentador',
    passive_levels: { '1': 'Alcance táctico +18%' },
    stats_real: { velocidad: 2500, agilidad: 94, blindaje: 1390, potencia_armas: 1410 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['canon_gsh301', 'misiles_r27', 'misiles_r73'] },
    is_active: true
  },
  {
    id: '27',
    name: 'MiG-21 Fishbed',
    type: 'Interceptor Supersónico Ligero',
    tier: 1,
    special_name: 'Trepada Mach 2 Delta',
    special_levels: { '1': 'Velocidad ascensional +20%' },
    passive_name: 'Firma Radar Mínima Clásica',
    passive_levels: { '1': 'Evasión BVR +12%' },
    stats_real: { velocidad: 2230, agilidad: 82, blindaje: 980, potencia_armas: 1120 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['canon_gsh23', 'misiles_r60', 'cohetes'] },
    is_active: true
  },
  {
    id: '28',
    name: 'MiG-23 Flogger',
    type: 'Caza Interceptor de Geometría Variable',
    tier: 2,
    special_name: 'Alas en Flecha Máxima',
    special_levels: { '1': 'Velocidad en línea recta +18%', '2': 'Velocidad en línea recta +32%' },
    passive_name: 'Radar Sapfir-23 BVR',
    passive_levels: { '1': 'Alcance de radar frontal +15%' },
    stats_real: { velocidad: 2445, agilidad: 80, blindaje: 1320, potencia_armas: 1300 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['canon_gsh23', 'misiles_r24', 'misiles_r60'] },
    is_active: true
  },
  {
    id: '29',
    name: 'MiG-31 Foxhound',
    type: 'Interceptor Pesado de Alta Cota',
    tier: 4,
    special_name: 'Radar Zaslon Phased Array',
    special_levels: { '1': 'Bloqueo multiobjetivo a larga distancia +25%', '2': 'Bloqueo multiobjetivo a larga distancia +45%' },
    passive_name: 'Supercrucero Mach 2.8',
    passive_levels: { '1': 'Velocidad máxima sostenida +20%' },
    stats_real: { velocidad: 3000, agilidad: 70, blindaje: 1700, potencia_armas: 1650 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['canon_gsh623', 'misiles_r33', 'misiles_r37'] },
    is_active: true
  },
  {
    id: '30',
    name: 'F-117 Nighthawk',
    type: 'Ataque Táctico Sigiloso',
    tier: 3,
    special_name: 'Invisibilidad Radar Facetada',
    special_levels: { '1': 'Detección radar -25%', '2': 'Detección radar -50%' },
    passive_name: 'Láser Paveway Quirúrgico',
    passive_levels: { '1': 'Precisión de impacto +30%' },
    stats_real: { velocidad: 1100, agilidad: 75, blindaje: 1200, potencia_armas: 1450 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['bombas_gbu27', 'bombas_gbu10'] },
    is_active: true
  },
  {
    id: '31',
    name: 'B-2 Spirit',
    type: 'Bombardero Estratégico Sigiloso',
    tier: 5,
    special_name: 'Ala Volante Anti-Radar Completo',
    special_levels: { '1': 'Inmunidad a bloqueo radar +30%', '2': 'Inmunidad a bloqueo radar +60%' },
    passive_name: 'Carga Bélica Masiva Guiada',
    passive_levels: { '1': 'Daño de bombardeo +25%' },
    stats_real: { velocidad: 1010, agilidad: 65, blindaje: 2000, potencia_armas: 1800 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['jdam', 'misiles_jsow'] },
    is_active: true
  },
  {
    id: '32',
    name: 'Mirage III',
    type: 'Caza Interceptor Clásico Ala Delta',
    tier: 1,
    special_name: 'Aceleración Cohete SEPR',
    special_levels: { '1': 'Empuje de emergencia +25%' },
    passive_name: 'Ala Delta Pura Suporsónica',
    passive_levels: { '1': 'Resistencia aerodinámica -15%' },
    stats_real: { velocidad: 2350, agilidad: 83, blindaje: 1080, potencia_armas: 1180 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['canon_defa', 'misiles_matra', 'bombas'] },
    is_active: true
  },
  {
    id: '33',
    name: 'Kfir C.10',
    type: 'Caza Polivalente Canard',
    tier: 2,
    special_name: 'Aviónica Elbit Radar EL/M-2032',
    special_levels: { '1': 'Adquisición de blancos +18%', '2': 'Adquisición de blancos +35%' },
    passive_name: 'Canards de Maniobra Kfir',
    passive_levels: { '1': 'Agilidad sostenida +14%' },
    stats_real: { velocidad: 2440, agilidad: 88, blindaje: 1250, potencia_armas: 1320 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['canon_defa', 'misiles_python', 'misiles_derby'] },
    is_active: true
  },
  {
    id: '34',
    name: 'EMB-314 Super Tucano',
    type: 'Avión de Ataque Ligero / COIN',
    tier: 1,
    special_name: 'Ataque Quirúrgico de Precisión',
    special_levels: { '1': 'Precisión de cañones/cohetes +25%' },
    passive_name: 'Firma Infrarroja Mínima',
    passive_levels: { '1': 'Evasión de misiles portátiles +20%' },
    stats_real: { velocidad: 590, agilidad: 92, blindaje: 950, potencia_armas: 1050 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['ametralladoras_127mm', 'cohetes_70mm', 'bombas_guiadas'] },
    is_active: true
  },
  {
    id: '35',
    name: 'IA-58 Pucará',
    type: 'Avión de Apoyo Táctico y COIN',
    tier: 1,
    special_name: 'Fuego Concentrado Cuádruple',
    special_levels: { '1': 'Cadencia de fuego terrestre +30%' },
    passive_name: 'Blindaje de Cabina de Acero',
    passive_levels: { '1': 'Resistencia a munición ligera +25%' },
    stats_real: { velocidad: 500, agilidad: 89, blindaje: 1020, potencia_armas: 1080 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['canones_hispano', 'ametralladoras_browning', 'cohetes'] },
    is_active: true
  },
  {
    id: '36',
    name: 'F-111 Aardvark',
    type: 'Interdictor de Penetración Pesado',
    tier: 3,
    special_name: 'Vuelo a Nivel de Copas de Árboles TFR',
    special_levels: { '1': 'Evasión por terreno +25%', '2': 'Evasión por terreno +45%' },
    passive_name: 'Bahía Interna Pave Tack',
    passive_levels: { '1': 'Precisión nocturna +22%' },
    stats_real: { velocidad: 2655, agilidad: 76, blindaje: 1650, potencia_armas: 1580 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['canon_vulcan', 'bombas_laser', 'misiles_agm'] },
    is_active: true
  },
  {
    id: '37',
    name: 'Su-34 Fullback',
    type: 'Cazabombardero Pesado Blindado',
    tier: 4,
    special_name: 'Cabina de Titanio Bipersonal',
    special_levels: { '1': 'Resistencia a daños +20%', '2': 'Resistencia a daños +38%' },
    passive_name: 'Radar de Cola Defensivo',
    passive_levels: { '1': 'Alerta de misiles por retaguardia +30%' },
    stats_real: { velocidad: 2200, agilidad: 87, blindaje: 1850, potencia_armas: 1620 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['canon_gsh301', 'misiles_kh31', 'bombas_kab'] },
    is_active: true
  },
  {
    id: '38',
    name: 'Su-47 Berkut',
    type: 'Caza Experimental de Flecha Invertida',
    tier: 5,
    special_name: 'Súper-Giro Flecha Invertida',
    special_levels: { '1': 'Maniobrabilidad instantánea +20%', '2': 'Maniobrabilidad instantánea +35%' },
    passive_name: 'Alta Sustentación Canard',
    passive_levels: { '1': 'Estabilidad a altos ángulos de ataque +25%' },
    stats_real: { velocidad: 2400, agilidad: 99, blindaje: 1380, potencia_armas: 1470 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['canon_gsh301', 'misiles_r77', 'misiles_r73'] },
    is_active: true
  },
  {
    id: '39',
    name: 'F-15C Eagle',
    type: 'Caza de Superioridad Aérea Invicto',
    tier: 4,
    special_name: 'Relación Empuje-Peso 1.4:1',
    special_levels: { '1': 'Aceleración vertical +18%', '2': 'Aceleración vertical +35%' },
    passive_name: 'Radar APG-63v3 AESA',
    passive_levels: { '1': 'Rango de fijación frontal +20%' },
    stats_real: { velocidad: 2660, agilidad: 91, blindaje: 1480, potencia_armas: 1520 },
    sistemas_disponibles: { fuselaje: true, motor: true, avionica: true, armas: ['canon_m61', 'misiles_aim120', 'misiles_aim9'] },
    is_active: true
  }
];
